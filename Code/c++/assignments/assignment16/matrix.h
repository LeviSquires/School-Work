...
public:
	...
	void SwitchRows(Matrix& m, unsigned row1, unsigned row2);
	std::vector<double> MultiplyRows(std::vector<double>& vec, int i );
	...
	void SetRowVector(std::vector<double> row, unsigned index);
